...
export function Header() {
  return (
    // Solid header — no backdrop-filter (it clips the logo ears in Chrome).
    <header className="sticky top-0 z-40 border-b border-black/10 bg-background">
      ...
      <div className="mx-auto flex min-h-[4.75rem] w-full max-w-6xl items-center justify-between gap-4 px-5 py-3 sm:min-h-[5.25rem] sm:px-6 sm:py-3.5 lg:gap-6 lg:px-8">
        <Wordmark />
